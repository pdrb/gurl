...
func Example() {
	...
	// {"body":"{\"name\": \"user\"}","method":"PUT","auth_header":["Bearer Token"],"content_header":["application/json; charset=utf-8"],"agent_header":["gurl 1.5.0"]}
	...
	// {"body":"{\"name\": \"user\"}","method":"DELETE","auth_header":null,"content_header":["text/plain; charset=utf-8"],"agent_header":["gurl 1.5.0"]}
	// {"body":"","method":"OPTIONS","auth_header":null,"content_header":null,"agent_header":["gurl 1.5.0"]}
	// {"body":"","method":"GET","auth_header":null,"content_header":null,"agent_header":["gurl 1.5.0"]}
	// {"body":"","method":"GET","auth_header":null,"content_header":null,"agent_header":["MyAgent"]}
	// {"body":"{\"fromfile\": true}","method":"POST","auth_header":null,"content_header":["application/json; charset=utf-8"],"agent_header":["gurl 1.5.0"]}
	// {"body":"","method":"GET","auth_header":null,"content_header":null,"agent_header":["gurl 1.5.0"]}
	// {"body":"","method":"GET","auth_header":null,"content_header":null,"agent_header":["gurl 1.5.0"]}
	// {"body":"","method":"GET","auth_header":null,"content_header":null,"agent_header":["gurl 1.5.0"]}
	// {"body":"","method":"GET","auth_header":null,"content_header":null,"agent_header":["gurl 1.5.0"]}
